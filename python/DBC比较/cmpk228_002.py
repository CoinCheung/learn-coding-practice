#!/usr/bin/python3
#filename: cmpk228_002.py
# designed for comparision between k228 and ep22, and k228 and as26
...
if __name__ == '__main__':
    ...
    writeResult(diff1y2n,diff1n2y,fname1,fname2,resname)
