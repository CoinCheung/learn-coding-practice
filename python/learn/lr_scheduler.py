...
if __name__ == "__main__":
    ...
    max_iter = int(218949 * 2048 / (64 * 2))
    n_iters_per_epoch = 10009
    step_interval = 2.4 * n_iters_per_epoch
    #  lr_scheduler = WarmupExpLrScheduler(
    #      optim, 0.97, step_interval=step_interval, warmup_iter=200,
    #      warmup_ratio=0.1, warmup='exp', last_epoch=-1)
    lr_scheduler = WarmupPolyLrScheduler(
        optim, 0.7, max_iter=10000, warmup_iter=1200,
        warmup_ratio=0.1, warmup='exp', last_epoch=-1)
    lrs = []
